...
\item \verb=set.pl= This \verb=perl= script puts together the
  \verb=case.in= files to be run. If changes are needed follow the
...
\item Length-Gauge: 
Layered response by bms-unpublished. See \verb=shg-layer-nonlocal.pdf=
\input{chis}
\end{itemize}
