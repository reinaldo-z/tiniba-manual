...
unset style line
set style line 50 lt 5 lw 0.1 lc rgb 'black'
unset style arrow
...
set xrange [ 0 : 52 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "\\Large $z$"
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ -8 : 18 ] noreverse nowriteback
set y2range [ * : * ] noreverse nowriteback
set zlabel "\\Large $\\rho_{n\\mathbf{k}}(z)$"
...
#load "/Users/sma/dev/gnuplot-colorbrewer/qualitative/Paired.plt"
GNUTERM = "wxt"
sp 'rhoz_1' u 1:2:(($3**2+$4**2)) t "$\\Gamma$" w lines
#    EOF
